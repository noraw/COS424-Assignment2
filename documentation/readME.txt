...
NOTES:
Train - use the data with 1's in last column
Test - 

Write a reader - Hansen

Hansen
Only calucate B for rows with 0 in last column.
Want to predict B given other features:
1.  32 reference samples
2.  previous 32 samples
3.  next 32 samples
4.  previous euclid distance
5.  next euclid distance


Nora
Multiple methods for predicting (sic-kit):
Nan treatment: as 0's, 1's, uniform random number
1.  Mean value prediction
2.  Linear Regression 
3.  Lasso
4.  Gaussian Process
